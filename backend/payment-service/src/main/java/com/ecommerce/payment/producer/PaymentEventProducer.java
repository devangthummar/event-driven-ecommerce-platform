...
public class PaymentEventProducer {
    ...
    public void publishPaymentSuccessEvent(PaymentSuccessEvent event) {
        ...
        log.info("Publishing PaymentSuccessEvent via Outbox & Kafka: topic={} for orderId={}, transactionId={}",
    ...
    public void publishPaymentFailedEvent(PaymentFailedEvent event) {
        String key = String.valueOf(event.getOrderId());
        log.info("Publishing PaymentFailedEvent via Outbox & Kafka: topic={} for orderId={}, reason={}",
